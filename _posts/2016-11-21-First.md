...
## Podsumowanie
Z komputerem można "rozmawiać" na wiele sposobów, ale nawet bardzo dobra znojność języków programowania oraz paradygmatów programowania nie wystarcza do tworzenia programów cechujących się dobrą jakością. W kolejnych seriach z cyklu "Wytwarzanie oprogramowania" zostaną opisane wybrane techniki pozwalające zbliżyć się do jakości akceptowalnej przez odbiorcę, bo przecież nie istnieją programy w 100% odporne na błędy, a może tak ;).
