...
### Język maszynowy
Z punktu widzenia komputera najbardziej przyjaznym językiem do komunikacji jest język składający się z dwóch znaków: 0 i 1. Jest to tak zwany język maszynowy. "Rozmowa" z komputerem w tym języku odbywa się poprzez wprowadzanie rozkazów reprezentowanych jako ciągi zer i jedynek. Każdy komputer posiada jednostkę zwaną procesorem, a każdy rodzaj procesora posiada swoją interpretację języka maszynowego. Dla przykładu poniższy kod reprezentuje język maszynowy zrozumiały dla procesora [Sextium II][1]. "Rozkazuje" on komputerowi wczytanie dwóch liczb ze standardowego wejścia, dodanie ich do siebie, oraz wypisanie wyniku na standardowe wyjście:
