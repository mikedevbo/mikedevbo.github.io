...
Głównym założeniem tego paradygmatu jest to aby kod dzielić na mniejsze kawałki, wykonujące jasno określone operacje. Większość języków wysokiego poziomu (a może wszystkie ;)) dostarczają konstrukcje zwane procedurami. W procedurach można zakodować poszczególne fragmenty programu, tak aby odseparować je od reszty, a także móc je wykorzystać w innych miejscach. Przykład podziału na procedury powyższego programu może wyglądać np. tak:
